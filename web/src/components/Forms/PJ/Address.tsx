...
import {
    usePJaddAddressMutation,
    usePJupdateAddressMutation,
    usePJremoveAddressesMutation
...
export const AddressForm: React.FC<AddressFormProps> = ({ initialData, defaultName, hasMain, PJCustomerID }) => {
    ...
    const [addAddress] = usePJaddAddressMutation();
    const [updateAddress] = usePJupdateAddressMutation();
    const [removeAddresses] = usePJremoveAddressesMutation();
